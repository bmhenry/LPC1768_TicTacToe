...
void GLCD_PutPixel (unsigned int x, unsigned int y) {
  GLCD_SetPixel(x, y, Color[TXT_COLOR]);
}


extern void GLCD_ClearPixel (unsigned int x, unsigned int y) {
  GLCD_SetPixel(x, y, Color[BG_COLOR]);
}
...
void GLCD_Bitmap (unsigned int x, unsigned int y, unsigned int w, unsigned int h, unsigned short *bitmap_ptr) {
  int i, j;
...
unsigned int GLCD_GetBgColor(void)
{
  return Color[BG_COLOR];
}


unsigned int GLCD_GetTxtColor(void)
{
